...
contextBridge.exposeInMainWorld('ttool', {
  ...
  screenshot: {
    ...
    listHistory: (options) => ipcRenderer.invoke('screenshot:listHistory', options),
    getHistoryItem: (id, includeDeleted) => ipcRenderer.invoke('screenshot:getHistoryItem', { id, includeDeleted }),
    historyStats: () => ipcRenderer.invoke('screenshot:historyStats'),
    ...
    setScreenshotFavorite: (id, favorite) => ipcRenderer.invoke('screenshot:setScreenshotFavorite', { id, favorite }),
    restoreScreenshot: (id) => ipcRenderer.invoke('screenshot:restoreScreenshot', { id }),
    quickSaveScreenshot: (id) => ipcRenderer.invoke('screenshot:quickSaveScreenshot', { id }),
    ...
    updatePinState: (id, action) => ipcRenderer.invoke('screenshot:updatePinState', { id, action }),
    ...
    copyPin: (id) => ipcRenderer.invoke('screenshot:copyPin', { id }),
    savePin: (id) => ipcRenderer.invoke('screenshot:savePin', { id }),
